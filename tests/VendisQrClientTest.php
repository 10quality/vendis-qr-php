...
final class VendisQrClientTest extends TestCase
{
    ...
    public function testItLogsIn(): void
    {
        ...
        $client = new VendisQrClient(new Configuration(Environment::Sandbox, 'https://vendis.test', 'api@example.test', 'secret', 'Tests'), $transport);
    ...
    public function testItRequiresCredentialsForLogin(): void
    {
        ...
        (new VendisQrClient(new Configuration(Environment::Sandbox, 'https://vendis.test')))->login();
    }
    /**
    ...
    public function testItRejectsLoginWithoutToken(): void
    {
        ...
        $client = new VendisQrClient(new Configuration(Environment::Sandbox, 'https://vendis.test', 'api@example.test', 'secret'), new FakeTransport([new Response(200, '{"message":"ok"}')]));
        $client->login();
    }
    /**
    ...
    public function testItGeneratesQr(): void
    {
        ...
        $client = new VendisQrClient(new Configuration(Environment::Sandbox, 'https://vendis.test', accessToken: 'yearly'), $transport);
    ...
    {
        $this->expectException(ConfigurationException::class);
        (new VendisQrClient(new Configuration(Environment::Sandbox, 'https://vendis.test')))->getQrStatus(1);
    }
    /**
    ...
    {
        $this->expectException(ApiException::class);
        $client = new VendisQrClient(new Configuration(Environment::Sandbox, 'https://vendis.test', accessToken: 'yearly'), new FakeTransport([new Response(404, '{"success":false,"message":"QR no encontrado"}')]));
    ...
    public function testItThrowsTransportExceptionForInvalidJson(): void
    {
        ...
        $client = new VendisQrClient(new Configuration(Environment::Sandbox, 'https://vendis.test', accessToken: 'yearly'), new FakeTransport([new Response(200, 'not-json')]));
        $client->getQrStatus(1);
    }
}
